...
namespace HiQo.StaffManagement.DAL.Database
{
    public class CompanyContext:DbContext
    {
        ...
        {
            modelBuilder.Entity<Role>().HasMany(r => r.Users).WithRequired(u => u.Role).WillCascadeOnDelete(false);
        ...
        {
            modelBuilder.Entity<Position>().HasMany(p=>p.Users).WithRequired(u=>u.Position).WillCascadeOnDelete(false);
        ...
        {
            modelBuilder.Entity<PositionLevel>().HasMany(pl=>pl.Users).WithRequired(u=>u.PositionLevel).WillCascadeOnDelete(false);
        ...
        {
            modelBuilder.Entity<Category>().HasMany(c=>c.Users).WithRequired(u=>u.Category).WillCascadeOnDelete(false);
            modelBuilder.Entity<Category>().HasMany(c => c.Positions).WithRequired(p =>p.Category).WillCascadeOnDelete(false);
        ...
        {
            modelBuilder.Entity<Department>().HasMany(d => d.Users).WithRequired(u => u.Department).WillCascadeOnDelete(false);
            modelBuilder.Entity<Department>().HasMany(d=>d.Categories).WithRequired(c=>c.Department).WillCascadeOnDelete(false);
